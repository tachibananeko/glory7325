! function(e) {
    ...
    class G {
        constructor() {
            let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
            if (this.useInstrumentation = void 0, G.instance) return G.instance;
            G.instance = this, this.useInstrumentation = e
        }
    ...
    function j(e) {
        void 0 !== e.granular_consent && function(e) {
            const t = e[c.MARKETING],
                ...
                r = e[c.ANALYTICS],
                i = e[c.PREFERENCES];
            !0 === t ? U(n.MARKETING_ACCEPTED) : !1 === t && U(n.MARKETING_DECLINED);
            !0 === o ? U(n.SALE_OF_DATA_ACCEPTED) : !1 === o && U(n.SALE_OF_DATA_DECLINED);
            !0 === r ? U(n.ANALYTICS_ACCEPTED) : !1 === r && U(n.ANALYTICS_DECLINED);
            !0 === i ? U(n.PREFERENCES_ACCEPTED) : !1 === i && U(n.PREFERENCES_DECLINED);
            const a = function(e) {
                const n = {
            ...
            U(n.CONSENT_COLLECTED, a);
            const s = [r, i, t, o];
            s.every((e => !0 === e)) && U(n.TRACKING_ACCEPTED);
            s.every((e => !1 === e)) && U(n.TRACKING_DECLINED)
        }({
            [c.PREFERENCES]: L(),
            [c.ANALYTICS]: v(),
            [c.MARKETING]: k(),
    ...
    function Y(e, n) {
        ...
        if (Array.isArray(e)) {
            const n = e.map((e => Y(e, !0))).join(",");
            return "[".concat(n, "]")
        }
        if ("object" == typeof e) {
            let t = [];
            for (const n in e) e.hasOwnProperty(n) && void 0 !== e[n] && t.push("".concat(n, ":").concat(Y(e[n], !0)));
            const o = t.join(",");
            return n ? "{".concat(o, "}") : o
        }
    ...
    G.instance = void 0;
    const B = "95ba910bcec4542ef2a0b64cd7ca666c";
    ...
    function x(e, n, t) {
        try {
            ...
            ! function(e) {
                const n = new XMLHttpRequest;
                n.open("POST", "https://error-analytics-production.shopifysvc.com", !0), n.setRequestHeader("Content-Type", "application/json"), n.setRequestHeader("Bugsnag-Api-Key", B), n.setRequestHeader("Bugsnag-Payload-Version", "5");
                const t = function(e) {
                    const n = function(e) {
                ...
                error: e,
                context: n,
                shopId: q() || (null === (o = window.Shopify) || void 0 === o ? void 0 : o.shop),
                notes: t
            })
        } catch (e) {}
    }
    ...
    function V(e) {
        return function() {
            try {
                ...
                throw e instanceof TypeError || x(e), e
            }
        }
    }
    ...
    function W(e, n) {
        ...
        return o.produce("setTrackingConsent"), "object" == typeof e && e.headlessStorefront && !e.storefrontAccessToken ? (C.warn("Headless consent has been updated. Please read shopify.dev/docs/api/customer-privacy to integrate."), o.produce("setTrackingConsent-Headless"), function(e, n) {
            ...
            const o = function(e) {
                ...
                r = function(e) {
                    if (!e) return null;
                    return Ee() ? window.location.pathname + window.location.search : "/"
                }(t.analytics);
            return ie(E(E({
                granular_consent: t
            }, null !== o && {
    ...
    const $ = e => {
        ...
        w() != i.DECLINED && !1 === Ae() && ce(!1, (() => !1));
        const o = {
            getTrackingConsent: ae,
            setTrackingConsent: W,
            userCanBeTracked: fe,
            getRegulation: se,
            isRegulationEnforced: de,
            getShopPrefs: ue,
            shouldShowGDPRBanner: pe,
            userDataCanBeSold: Ce,
            setCCPAConsent: ce,
            getCCPAConsent: ge,
            shouldShowCCPABanner: Te,
            doesMerchantSupportGranularConsent: _e,
            analyticsProcessingAllowed: v,
            preferencesProcessingAllowed: L,
            marketingAllowed: H,
            firstPartyMarketingAllowed: H,
            saleOfDataAllowed: J,
            thirdPartyMarketingAllowed: J,
            currentVisitorConsent: X,
            shouldShowBanner: M,
            saleOfDataRegion: F,
            getRegion: le,
            getTrackingConsentMetafield: he,
            consentId: Ne,
            unstable: {
                analyticsProcessingAllowed: v,
                preferencesProcessingAllowed: L,
        ...
        if (new G(t), !n) return o;
        const r = ["unstable", "__metadata__"];
        for (const e in o) o.hasOwnProperty(e) && (o[e] = r.includes(e) ? o[e] : V(o[e]));
        return o
    };
    ...
    function z(e) {
        ...
        const n = function(e) {
            const n = new URL(e, window.location.origin),
                t = ee(e) ? Q(n) : Q(n).replace(window.location.origin, "");
        ...
        for (const r of Array.from(n)) {
            ...
            if (t && i.searchParams.set("consent_id", t), o && i.searchParams.set("consent", o), t || o) {
                const n = ee(e) ? i.toString() : i.toString().replace(window.location.origin, "");
    ...
    function ie(e, n) {
        ...
        return fetch("https://".concat(r, "/api/unstable/graphql.json"), c).then((e => {
            ...
            return T(_, u, c, E), d && f && (T(te, u, a, d), T(oe, u, a, f)), l !== u && (T(_, l, c, E), d && f && (T(te, l, a, d), T(oe, l, a, f))), j(e), z(A), void 0 !== n && n(null, o), o
        })).catch((e => {
    ...
    function ae() {
        if ((new G).produce("getTrackingConsent"), y()) return r.NO_VALUE;
        const e = S();
    ...
    function se() {
        (new G).produce("getRegulation"), C.warn("getRegulation is deprecated and will be removed.");
        const e = O();
    ...
    function ue() {
        return (new G).produce("getShopPrefs"), C.warn("getShopPrefs is deprecated and will be removed."), {
            limit: []
        }
    }
    ...
    function de() {
        return (new G).produce("isRegulationEnforced"), C.warn("isRegulationEnforced is deprecated and will be removed."), !0
    }
    ...
    function pe() {
        return M() && ae() === r.NO_INTERACTION
    }

    function ge() {
        return !1 === Ae() ? r.DECLINED : (e = w(), y() ? r.NO_VALUE : e === i.NO_VALUE ? r.NO_INTERACTION : D(e));
        var e
    }

    function Te() {
        return (new G).produce("shouldShowCCPABanner"), C.warn("shouldShowCCPABanner is deprecated and will be removed."), F() && ge() === r.NO_INTERACTION
    }
    ...
    function me() {
        ...
        window.Shopify.customerPrivacy = window.Shopify.trackingConsent = o, U(n.CONSENT_TRACKING_API_LOADED)
    }
    window.Shopify = window.Shopify ? window.Shopify : {}, me(), e.default = Z, e.setGlobalObject = me, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}({});
