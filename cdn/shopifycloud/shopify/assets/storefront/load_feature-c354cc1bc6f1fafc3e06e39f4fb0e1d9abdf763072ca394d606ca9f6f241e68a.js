        ...
        p = e((function(e, t) {
            ...
            function r(e) {
                var t = e.name,
                    ...
                    d = n || t,
                    f = (void 0 === c ? null : c) || d;
                if (f.endsWith(".js") && (f = f.slice(0, -3)), o && (f += "-legacy"), s && (f = f + "." + (s = 0 === l.length || l.includes(s) ? s : "en")), ("shop-js" === t || t.startsWith("shop-js/")) && window.Shopify.developmentShopJsUrl) return "https://" + window.Shopify.developmentShopJsUrl + "/" + f + ".js";
