! function() {
    var e = {
            ...
            5730: function(e, t, n) {
                ...
                t.saleOfDataRegion = r.saleOfDataRegion, t.GPCSignal = p, t.doesMerchantSupportGranularConsent = function() {
                    return !0
                ...
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    ...
                    return fetch(`https://${p}/api/unstable/graphql.json`, _).then((e => {
                        ...
                        const p = 31536e6,
                            ...
                            E = n.storefrontRootDomain || _ || window.location.hostname,
                        ...
                        return r.writeCookie(i.CONSENT_COOKIE_NAME, h, p, g), v && y && (r.writeCookie(u, h, f, v), r.writeCookie(d, h, f, y)), E !== h && (r.writeCookie(i.CONSENT_COOKIE_NAME, E, p, g), v && y && (r.writeCookie(u, E, f, v), r.writeCookie(d, E, f, y))), o.dispatchEvents(e), c.appendConsentToCustomerAccountLinks(m), void 0 !== t && t(null, a), a
                    })).catch((e => {
                ...
                var a = n(9414),
                    ...
                    p = function(e) {
                        ...
                        return r(t, e), t.prototype.initialize = function() {
                            ...
                            var n = this.options;
                            "localhost" === s.hostname() && (n.domain = "none"), n.enhancedEcommerce && this.enhancedEcommerce(), l.shouldSetGoogleConsentMode() && window.gtag("consent", "default", l.generateGoogleConsentModeObject()), window.ga("create", n.trackingId, {
                            ...
                            l.shouldSetGoogleConsentMode() && window.gtag("consent", "update", l.generateGoogleConsentModeObject()), d.analyticsProcessingAllowed() ? delete window["ga-disable-" + this.options.trackingId] : window["ga-disable-" + this.options.trackingId] = !0, e.prototype.onConsentCollected.call(this, t)
                        }, t.prototype.hasConsent = function(e) {
                            ...
                            if (o) {
                                ...
                                for (var s = [], c = 0, u = r; c < u.length; c++) {
                                    var d = u[c],
                                        l = this.createProductTrack(t, d),
                                        p = {
                                            category: l.category,
                                            quantity: this.getProductQuantity(l),
                                            price: l.price,
                                            name: l.name,
                                            sku: l.sku || l.variantId,
                                            id: o,
                                            currency: this.getCurrency(l.currency)
                                        };
                                    window.ga("ecommerce:addItem", p), s.push(p)
                                }
                            ...
                            if (o) {
                                ...
                                for (var i = [], s = 0, c = r; s < c.length; s++) {
                                    var u = c[s],
                                        ...
                                        l = this.enhancedEcommerceTrackProduct(d);
                                    i.push(l)
                                }
                                var p = {
                                    id: o,
                                ...
                                window.ga("ec:setAction", "purchase", p);
            ...
            3988: function(e, t, n) {
                ...
                var v = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        return E.analyticsProcessingAllowed(e) || E.marketingAllowed(e)
                        ...
                        var t, n = e.eventName,
                            ...
                            i = e.eventSchemaId,
                            a = e.source;
                        if (t = i || (this.isCustomStorefront(n) ? l.customStorefrontAnalyticsSchemaId : l.storefrontAnalyticsSchemaId), this.isCustomStorefront(n)) {
                            ...
                            t === l.storefrontAnalyticsSchemaId ? this.emitToStoreFrontCustomerTracking(c) : this.emitToCustomSchema(c, t)
                        }
                        ...
                        var t = i(i({}, e), {
                            ...
                            a = {
                                schemaId: l.storefrontAnalyticsSchemaId,
                                payload: r
                            };
                        d.produce([n, a])
                        ...
                        return i(i({
                            ...
                            asset_version_id: "fc89087661a0619ee61984dff12e5581bfee89c0",
                            ...
                            analytics_allowed: E.analyticsProcessingAllowed(),
                            marketing_allowed: E.marketingAllowed(),
            ...
            3082: function(e, t, n) {
                ...
                var l = function(e) {
                    ...
                    return r(n, e), n.prototype.initialize = function() {
                        this.timestampManager = new p, this.campaignManager = new f, e.prototype.initialize.call(this)
            ...
            4252: function(e, t, n) {
                ...
                function g(e) {
                    if (void 0 === o && (!p.default.isEnabled(p.TREKKIE_COOKIE_DOMAIN_FIX) || T(e)))
                        if (function() {
                ...
                t.parseDocumentCookie = E, t.cookieImpl = {
                    parse: E,
                    read: function(e) {
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "fc89087661a0619ee61984dff12e5581bfee89c0",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
                    ...
                    v = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "fc89087661a0619ee61984dff12e5581bfee89c0",
                            ...
                            try {
                                if ("product_added_to_cart" === u && (null === (o = window.Shopify) || void 0 === o ? void 0 : o.evids)) {
                                    var l = function(e) {
                                        ...
                                        p = null !== (r = y[e]) && void 0 !== r ? r : y.default;
    ...
    n.d = function(e, t) {
        ...
        function() {
            ...
            i.push(["S2S", d.S2S]);
            try {
                var l = window[r].config;
                if (l) {
                    t.setGlobalSerializedAppConfig(JSON.stringify(l));
                    var p = window[r],
                        f = window.trekkie = new e.Tricorder(i, l, (function() {
