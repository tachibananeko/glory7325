(() => {
    ...
    n.amdO = {}, n.n = e => {
        ...
        function Ne() {
            window.Shopify = window.Shopify || {}, window.Shopify.evids || (Te = {}, Re = {
                [Ie]: {},
                [Ae]: {},
                [Oe]: {}
                ...
                if (! function(e) {
                    ...
                    }(e) || (null == t ? void 0 : t.analyticsFramework) !== Ae && "wpm" !== (null == t ? void 0 : t.analyticsFramework) && (null == t ? void 0 : t.analyticsFramework) !== Oe) return Pe("shu");
                ...
                return function(e, t, n) {
                    var r, o;
                    const i = null !== (r = Te[e]) && void 0 !== r ? r : Te[e] = {},
                        a = null !== (o = i[n]) && void 0 !== o ? o : [];
                    let s = a[t];
                    return s || (s = Pe(), a.push(s)), i[n] = a, s
                }(e, o, n)
            }(...e))
        }
        let De = function(e) {
        ...
        const ze = "webPixelsManager",
            Be = "0.0.475",
            qe = "modern",
            Ve = "230b189fw3875b864p642644e6m74838f3a",
            Fe = "b230b189fw3875b864p642644e6m74838f3am.js",
            He = "loggedConversion2",
            We = "isMerchantSession",
            Xe = () => {
                let e, t;
                return {
        ...
        const et = {
            ...
            tt = {
                metadata: {
                    shopId: -1,
                    surface: je.NotAvailable,
                    browserTarget: Me.NotAvailable,
                    shopDomain: "n/a"
                },
                notify: (e, t) => {
                    try {
                        if (t ? .options ? .sampleRate && !Ke(t.options.sampleRate)) return;
                        const o = { ...et,
                            ...t,
                            ...tt.metadata,
                            shopUrl: self.location.href
                        };
                        if (o.browserTarget === Me.NotAvailable || o.browserTarget === Me.Unknown || o.surface === je.NotAvailable || o.surface === je.Unknown || !nt(o.shopUrl)) return void(console ? .error && console.error(e));
                        let i = {
                            errorClass: e ? .name,
                            message: e ? .message,
                            stacktrace: [],
                            ...
                            i = function(e) {
                                ...
                                const n = Je().parse(e).reduce(((e, t) => {
                                    const n = function({
                                        ...
                                        var o;
                                        return {
                                            file: `https://cdn.shopify.com/cdn/wpm/${Fe}`,
                                            method: r,
                                            lineNumber: t,
                                            columnNumber: n
                                        }
                            ...
                            try {
                                i = function(e, t) {
                                    ...
                                    if (e.stackTrace || e.stack || e.description) {
                                        ...
                                        if (t && t.length > 2 && (r.lineNumber = t[1], r.columnNumber = t[2], parseInt(r.lineNumber, 10) > 1e5)) throw new Ge
                                    }
                                    return {
                                        errorClass: e ? .name || n,
                                        message: e ? .message || n,
        ...
        function It(e, t = !1) {
            const n = {
                ...
                metadata: {
                    event_created_at_ms: Tt()
                }
            };
            kt.push(n), t ? Ot() : void 0 === Ct && (Ct = setTimeout(Ot, 500))
        }
        ...
        function Ot({
            ...
            if (Ct = void 0, 0 === kt.length) return;
            const t = [...kt];
            kt.length = 0,
                function(e, t) {
                    ...
                    ! function(e, t) {
                        const n = `${function(e){return{global:"https://monorail-edge.shopifysvc.com",wellKnown:`${_t}/.well-known/shopify/monorail`,staging:"https://monorail-edge-staging.shopifycloud.com",test:"https://localhost"}[e||"wellKnown"]}(St)}/unstable/produce_batch`;
                        try {
        ...
        function Dt() {
            if (!Pt && (Pt = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto), !Pt)) throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
            return Pt(Nt)
        }
        const jt = [];
        ...
        const Ut = function(e, t, n) {
            ...
            return function(e, t = 0) {
                return jt[e[t + 0]] + jt[e[t + 1]] + jt[e[t + 2]] + jt[e[t + 3]] + "-" + jt[e[t + 4]] + jt[e[t + 5]] + "-" + jt[e[t + 6]] + jt[e[t + 7]] + "-" + jt[e[t + 8]] + jt[e[t + 9]] + "-" + jt[e[t + 10]] + jt[e[t + 11]] + jt[e[t + 12]] + jt[e[t + 13]] + jt[e[t + 14]] + jt[e[t + 15]]
            }(r)
        };
        let $t;
        ...
        const Bt = e => "number" == typeof e ? new zt(e) : new Map,
            qt = (...e) => JSON.stringify(e);
        ...
        const Ft = Vt(((e = "") => {
            ...
            Kt = e => {
                const t = Wt();
                return t ? Ht(t)[e] : void 0
            },
            Yt = "wpm-test-cookie",
            Jt = new Map;
        const Gt = () => Kt("_shopify_y") ? ? "";
        n(7960);
        ...
        function en(e, {
            ...
            function a(t) {
                t.source === e.contentWindow && t.data === Qt && (window.removeEventListener("message", a), i())
            }
            null === (r = e.contentWindow) || void 0 === r || r.postMessage(Qt, n);
        ...
        const tn = Symbol.for("RemoteUi::Retain"),
            nn = Symbol.for("RemoteUi::Release"),
            rn = Symbol.for("RemoteUi::RetainedBy");
        class on {
            constructor() {
                this.memoryManaged = new Set
            }
            add(e) {
                this.memoryManaged.add(e), e[rn].add(this), e[tn]()
            }
            release() {
                for (const e of this.memoryManaged) e[rn].delete(this), e[nn]();
                this.memoryManaged.clear()
            }
        }

        function an(e) {
            return Boolean(e && e[tn] && e[nn])
        }

        function sn(e, {
            deep: t = !0
        } = {}) {
            return cn(e, t, new Map)
        }
        ...
        function cn(e, t, n) {
            ...
            if (null != r) return r;
            const o = an(e);
            if (o && e[tn](), n.set(e, o), t) {
                if (Array.isArray(e)) {
                    const r = e.reduce(((e, r) => cn(r, t, n) || e), o);
                    return n.set(e, r), r
                }
                if (un(e)) {
                    const r = Object.keys(e).reduce(((r, o) => cn(e[o], t, n) || r), o);
                    return n.set(e, r), r
                }
            }
            return n.set(e, o), o
        ...
        function dn(e) {
            ...
            function o(t, n) {
                if ("object" == typeof t) {
                    ...
                    if (un(t)) return Object.keys(t).reduce(((e, r) => ({ ...e,
                        [r]: o(t[r], n)
                    })), {})
                }
                return t
        ...
        function gn() {
            const e = function(e) {
                ...
                const e = function() {
                    try {
                        const e = sessionStorage.getItem(bn);
                ...
                return e || function() {
                    ...
                    }(new URLSearchParams(self.location.search).get(bn));
                    return function(e) {
        ...
        function yn(e) {
            ! function(e) {
                try {
                    sessionStorage.setItem(bn, JSON.stringify(e))
                } catch {
                    t = "Session storage is not available. The Pixel Helper experience may be degraded.", vn.has(t) || (vn.add(t), "console" in self && console.warn(t))
                }
                var t
            }(e)
        }
        const xn = "web-pixels-helper-sandbox-handle",
            _n = {
                height: "26px",
                width: "21px",
                top: "12px",
        ...
        async function In({
            ...
            const n = await async function({
                    ...
                    const t = `${e}/web-pixels-helper/h${Ve}m.html`,
                        {
                            height: n,
                            position: r
                        } = gn();
            ...
            return r.expose({ ...An(n, t)
                }),
                function(e) {
                    if (e.querySelector(`#${xn}`)) return;
                    const t = document.createElement("div");
                    var n;
                    t.setAttribute("id", xn), mn(t, {
                        display: "block",
                        position: "absolute",
                        cursor: "grab",
                        background: "transparent",
                        ...
                        return e => {
                            e.preventDefault(), n[3] = e.clientX, n[4] = e.clientY, self.addEventListener("mouseup", o), self.addEventListener("mousemove", r), mn(t, En, {
                                important: !0
                            })
                        }
                    }(n, {
        ...
        function An(e, t) {
            return {
                async setHelperReady() {
                    e.container.showPopover(), mn(e.container, {
                        visibility: "visible",
                        opacity: "1"
                    }, {
                        important: !0
        ...
        const Tn = function() {
                const e = new Zt(1e3, "newest");
                let t = null;
                const n = () => {
                    try {
                        return "true" === self.localStorage.getItem("pixel-helper-advanced") ? On.Advanced : On.Standard
                    } catch {
                        return On.Standard
                    }
                };
        ...
        class Pn {
            constructor({
                ...
                this.channelSubscribers = new Map, this.replayQueue = void 0, this.bufferSize = void 0, this.replayKeep = void 0, this.subscribeAllKey = void 0, this.eligibility = void 0, this.bufferSize = e, this.replayKeep = t, this.subscribeAllKey = n, this.replayQueue = new Zt(e, t), this.eligibility = null != r ? r : Rn
            }
            publish(e, t, n = {}) {
                var r;
        ...
        const Un = "[object Undefined]",
            $n = "[object Null]",
            Ln = ["[object String]", "[object Number]", "[object Boolean]", Un, $n],
            Mn = e => null === e ? $n : void 0 === e ? Un : Object.prototype.toString.call(e);
        ...
        function zn(e) {
            ...
            return void 0 === e || r(e) ? {
                isValid: function e(o, i = "root") {
                    ...
                    const a = Mn(o),
                        s = Ln.includes(a);
                    return s || (n = i, t = `Value of type "${a}" at "${n}" must be one of the following types: ${Ln.join(", ")}.`), s
                }(e, "root"),
                error: t,
                errorKey: n
            } : (n = "root", t = `Value of type "${Mn(e)}" at "${n}" must be an object.`, {
                isValid: !1,
                error: t,
                errorKey: n
            })
        ...
        const qn = Vt((e => {
            ...
            Vn = ["page_viewed", "product_viewed", "collection_viewed", "cart_viewed", "clicked", "form_submitted", "input_blurred", "input_focused", "input_changed", "advanced_dom_clicked", "advanced_dom_scrolled", "advanced_dom_window_resized"];

        function Fn(e, t, n) {
            try {
                if (!Vn.includes(e.name)) return;
                const r = Kt("_shopify_s") || "";
                (function(e, t) {
                    if (!t) return !1;
                    return qn(t.toLowerCase()) % 100 + 1 <= 1
                })(0, r) && At("buyerEventSample", {
                    shopId: t,
                    eventType: e.type,
                    eventName: e.name,
                    surface: n,
        ...
        const Hn = {
            all_events: De.Meta,
            all_standard_events: De.Meta,
            all_custom_events: De.Meta,
            all_dom_events: De.Meta,
            checkout_address_info_submitted: De.Standard,
            checkout_completed: De.Standard,
            checkout_started: De.Standard,
            payment_info_submitted: De.Standard,
            collection_viewed: De.Standard,
            checkout_contact_info_submitted: De.Standard,
            page_viewed: De.Standard,
            product_added_to_cart: De.Standard,
            product_removed_from_cart: De.Standard,
            product_viewed: De.Standard,
            search_submitted: De.Standard,
            cart_viewed: De.Standard,
            checkout_shipping_info_submitted: De.Standard,
            alert_displayed: De.Standard,
            ui_extension_errored: De.Standard,
            input_changed: De.Dom,
            input_blurred: De.Dom,
            input_focused: De.Dom,
            form_submitted: De.Dom,
            clicked: De.Dom,
            advanced_dom_mouse_moved: De.AdvancedDom,
            advanced_dom_window_resized: De.AdvancedDom,
            advanced_dom_scrolled: De.AdvancedDom,
            advanced_dom_clipboard: De.AdvancedDom,
            advanced_dom_selection_changed: De.AdvancedDom,
            advanced_dom_available: De.AdvancedDom,
            advanced_dom_changed: De.AdvancedDom,
            advanced_dom_clicked: De.AdvancedDom,
            advanced_dom_form_submitted: De.AdvancedDom,
            advanced_dom_input_changed: De.AdvancedDom,
            advanced_dom_input_blurred: De.AdvancedDom,
            advanced_dom_input_focused: De.AdvancedDom
        };
        ...
        const Zn = new Map,
            ...
            er = e => ({ ...e,
                ...
                context: Gn(),
                id: "string" == typeof e.id && e.id.length > 0 ? e.id : Ut(),
                seq: Qn(e.name)
            });
        ...
        function ar(e) {
                ...
                o = new Pn({
                    ...
                    eligibility: (...e) => Jn(...e) && ((e, t, n) => {
                        ...
                        const {
                            ...
                            capabilities: o,
                            type: i
                        } = r || {}, a = o ? .includes(Le.AdvancedDomEvents);
            ...
            return {
                publish(n, r, o) {
                    ...
                    if (!Xn(n)) return !1;
                    if ("checkout_completed" === n && Bn() && "1" === Kt(He)) return !1;
                    const i = zn(r);
                    if (!i.isValid) return console.error(i.error), !1;
                    const a = tr(n, r, o),
                        s = a.data ? .checkout ? .token;
                    return Fn(a, e.shopId, e.surface), At("eventPublish", {
                            version: Be,
                            bundleTarget: qe,
                            pageUrl: self.location.href,
                            shopId: e.shopId,
                            surface: e.surface || je.Unknown,
                            eventName: a.name,
                            eventType: a.type,
                            ...
                            "checkout_completed" === e && function() {
                                if (Bn()) {
                                    const e = self.location.pathname.split("/").slice(0, -1).join("/"),
                                        t = new Date;
                                    t.setMonth(t.getMonth() + 2), Xt(`${He}=1; expires=${t}; path=${e}`)
                                }
                            }()
                ...
                publishDomEvent(t, n, i) {
                    if ("string" != typeof t) {
                        ...
                        throw new ir(`Expected event name "${e}" to be a string, but got ${typeof t}`)
                    }
                    if (!Kn(t) && !Yn(t)) throw new ir(`Event name "${t}" is not a supported DOM Event`);
                    const a = zn(n);
                    if (!a.isValid) throw new ir(`Input Validation Error for event ${t}: ${a.error}\nPayload: ${JSON.stringify(n)}`);
                    const s = tr(t, n, i);
                    return Fn(s, e.shopId, e.surface), Yn(t) ? o.publish(t, s) : r.publish(t, s)
                },
                subscribe(i, a, s = {}) {
                    const c = Ut(),
                        u = async t => {
                            if (e.surface === je.CheckoutOneSdk && s.scope !== Nn.CheckoutOneSdk) return;
                            const n = {
                            ...
                            let o;
                            try {
                                await a.call(t, t), Tn.message("logEvent", r)
                            } catch (f) {
                                o = f, Tn.message("logEvent", { ...r,
                                    status: "FAIL",
                                    error: o
                                })
                            }
                            const u = Wn(t.name),
                                ...
                                d = o ? "FAILURE" : "SUCCESS",
                                p = o ? String(o) : void 0;
                            if ([De.Dom, De.AdvancedDom].includes(u)) Ke(1) && At("subscriberEventEmitDom", { ...l,
                                status: d,
                                errorMessage: p
                            });
                            else {
                                let e;
                                Xn(t.name) && (e = t ? .data ? .checkout ? .token), At("subscriberEventEmit", { ...l,
                                    eventType: u,
                    ...
                    if (Yn(i)) return o.subscribe(i, u, s);
                    if ("all_events" === i) {
                        const e = t.subscribe(nr, u, s),
                            o = n.subscribe(rr, u, s),
                            i = r.subscribe(or, u, s);
                        return () => {
                            const t = e(),
                                n = o(),
                                r = i();
                    ...
                    return i === rr ? n.subscribe(rr, u, s) : i === nr || Xn(i) ? t.subscribe(i, u, s) : i === or || Kn(i) ? r.subscribe(i, u, s) : n.subscribe(i, u, s)
                }
            }
        }
        const sr = ["31014027265", "28638674945", "44186959873"];
        ...
        function cr({
            ...
            const c = function(e) {
                return e === je.Shopify || e === je.CheckoutOne || e === je.CheckoutOneSdk ? Dn.Checkout : e === je.StorefrontRenderer ? Dn.Storefront : Dn.Unknown
            }(o);
            var u, l, d, p;
            return {
                analytics: {
                    subscribe: (t, i, s) => (a && sn(i), e.subscribe(t, i, { ...s,
                        pixelRuntimeConfig: n,
                        shopId: r,
                        surface: o,
                        scope: Nn.WebPixelExtension
                    }))
                },
                browser: {
                    cookie: {
                        get: async e => e ? Kt(e) ? ? "" : Wt() ? ? "",
                        set: async (e, t) => {
                            if (t) {
                                const n = `${e}=${t}`;
                                document.cookie = n
                ...
                customerPrivacy: {
                    subscribe: (e, i, s) => (a && sn(i), t.subscribe(e, i, { ...s,
                        pixelRuntimeConfig: n,
                        shopId: r,
                        surface: o,
                        scope: Nn.WebPixelExtension
        ...
        async function vr(e) {
            ...
            switch (r.restrictions || (r.restrictions = function(e, t) {
                if (!e) return {};
                const n = function(e) {
                        return sr.includes(String(e))
                    }(e),
                    r = t !== je.StorefrontRenderer;
                return n && r ? {
                    allowedEvents: [],
                ...
                }(r.privacyPurposes)), Tn.message("logConsentGranted", {
                    pixelUid: {
                        id: s,
                        type: r.type
                    }
                ...
                case $e.Strict:
                    try {
                        t = await async function({
                            ...
                            const c = `web-pixel-sandbox-${e.type}-${e.id}-${e.runtimeContext}-${Ve}`;
                            if (e.runtimeContext === $e.Lax && document.getElementById(c)) {
                                const t = new dr;
                                throw tt.notify(t, {
                                    pixelId: e.id,
                                    pixelType: e.type,
                            ...
                            switch (e.runtimeContext) {
                                case $e.Strict:
                                    [u, l] = await async function({
                                        ...
                                        const r = t.id,
                                            o = [gt(n), "/wpm", `@${Ve}`, `/web-pixel-${r}`, `@${t.scriptVersion}`, "/sandbox", `/worker.${qe}.js`];
                                        ...
                                        const i = o.join(""),
                                            ...
                                            s = new Promise(((e, t) => {
                                                const n = e => {
                                                    a.removeEventListener("error", n), t(e ? .filename && e ? .lineno && e ? .message ? new ur(e.message, i) : new Error(`Failed to load web worker for pixel ${r} with url ${i}}`))
                                                };
                                ...
                                case $e.Lax:
                                    [u, l] = await async function({
                                        ...
                                        const {
                                            search: r
                                        } = self.location, o = t.id, i = t.type.toLowerCase(), a = [gt(n), "/wpm", `@${Ve}`, `/${i}`, `/web-pixel-${o}`, `@${t.scriptVersion}`, "/sandbox", `/${qe}`, /\.(js|json|xml)$/.test(self.location.pathname) ? "" : self.location.pathname, r];
                                        if (n.match(/spin\.dev\/?/)) {
                                            const e = r.length ? "&" : "?";
                            ...
                            const m = e.runtimeContext === $e.Lax ? (lr || (lr = {
                            ...
                            if (l && v.push(l), await Promise.race(v), Ve !== h.hashVersion) {
                                const t = new Error(`The main bundle hash (${Ve}) does not match the sandbox hash (${h.hashVersion})`);
                                throw tt.notify(t, {
                                    severity: "warning",
                                    pixelId: e.id,
                                    pixelType: e.type,
                    ...
                    try {
                        t = await async function({
                            ...
                            const {
                                ...
                                type: d,
                                integrityHash: p
                            } = e, f = `${l}-${d}`.toLowerCase(), h = dt("72028870");
                            mr.set(f, (() => ({
                                webPixelApi: cr({
                                    eventBus: t,
                                    customerPrivacyEventBus: n,
                            ...
                            const v = o.match(/spin\.dev\/?/),
                                b = [gt(o), `/wpm@${Ve}`, `/${e.type.toLocaleLowerCase()}`, `/web-pixel-${l}@${e.scriptVersion}`, h ? "~2" : "", `/pixel.${qe}.js`, v ? "?fast_storefront_renderer=1" : ""].join("");
                            if (!self[ze]) {
                            ...
                            if (!("createShopifyExtend" in self[ze])) {
                                ...
                                Mt(self[ze], "createShopifyExtend", {
                                    value: e,
                                    enumerable: !1,
                                    writable: !1,
                                    configurable: !1
                            ...
                            return await (w = b, g = e => {
                                e.dataset.pixelId = l, e.dataset.pixelType = d, h && (p ? (e.integrity = p, e.crossOrigin = "anonymous") : tt.notify(new Error(`Missing integrityHash for SRI-enabled open pixel of type ${d} with id ${l} and src ${b}`), {
                ...
                default:
                    {
                        ...
                        throw Tn.message("logPixelRegister", {
                            pixelUid: {
                                id: s,
                                type: r.type
                            },
            ...
            n && !t ? Tn.message("logPixelRegister", {
                pixelUid: {
                    id: s,
                    type: r.type
                },
                status: "FAIL",
                errorType: n instanceof pr ? "PixelInitializationError" : "PixelRegistrationError",
                error: n
            }) : t && Tn.message("logPixelRegister", {
                pixelUid: {
                    id: s,
                    type: r.type
                },
        ...
        function yr() {
            return new Promise((e => {
                if (wr.add(e), "visible" === document.visibilityState) return document.addEventListener("visibilitychange", gr), void requestAnimationFrame((() => setTimeout((() => {
                    wr.delete(e), e()
                }))));
                gr()
            }))
        ...
        let xr;
        const _r = () => (void 0 === xr && (xr = function() {
                let e = !1;
                try {
                    const t = {
                            get passive() {
        ...
        function Sr(e, t, n, r = {}) {
            const o = r.addEventListenerOptions ? { ...Er,
            ...
            try {
                ...
                return e.addEventListener(t, i, _r() ? o : o.capture), () => {
                    e.removeEventListener(t, i, _r() ? o : o.capture)
                }
            } catch (i) {
                tt.notify(i, {
        ...
        const Cr = new RegExp(["password", "pass", "pw", "ssn", "sin", "social", "security", "cc", "card", "creditcard", "cvv", "cvc", "cvn", "billing", "license", "health", "secret", "unique"].map((e => `^(.*[^a-z])?${e}([^a-z].*)?$`)).join("|"), "i"),
            Ir = function(e, {
                cache: t,
                cacheKey: n
            } = {}) {
                ...
                return !!Sn(e) && null !== e.closest('script, iframe, [data-shopify-privacy="exclude"], [hidden]')
            }), {
                cacheKey: e => e
            }),
            Ar = ["id", "name", "type"],
        ...
        function Tr(e, t, n) {
            const r = t.reduce(((t, r) => {
                const o = function(e, t, n) {
                    if (t in e) {
                        const n = e[t];
                        if (Or.includes(typeof n)) return n
                    }
            ...
            return ((e, t) => {
                "value" in t && "string" == typeof t.value && (e => {
                    ...
                    return "redact" === t || Ar.some((t => {
                        const n = e.getAttribute(t);
                        return "string" == typeof n && n.match(Cr)
                    }))
                })(e) && (t.value = "******")
            })(e, r), r
        }
        ...
        const Dr = ["screenX", "screenY", "pageX", "pageY", "clientX", "clientY", "offsetX", "offsetY", "movementX", "movementY"],
            jr = Dr.reduce(((e, t) => (e[t] = 0, e)), {});
        let Ur = 0;
        const $r = new WeakMap;
        ...
        function Lr(e) {
            if (!e) return -1;
            let t = $r.get(e);
            return void 0 === t && (t = Ur, $r.set(e, t), Ur += 1), t
        }
        ...
        function zr(e) {
            ...
            if (!Mr.has(e)) {
                ...
                for (; t && Ir(t);) t = t.previousSibling;
                Mr.set(e, {
                    parentSerializationId: Lr(e.parentNode),
                    prevSiblingSerializationId: Lr(t)
                })
            }
            return Mr.get(e)
        }
        ...
        const qr = ["checkbox", "radio"];

        function Vr(e) {
            const t = {
                nodeType: e.nodeType,
                serializationId: Lr(e)
            };
            if (e instanceof Element) {
                if (t.attributes = Tr(e, [...e.getAttributeNames(), "value"]), e instanceof HTMLInputElement && qr.includes(e.type)) {
        ...
        const Hr = [HTMLInputElement, HTMLSelectElement, HTMLTextAreaElement, HTMLButtonElement],
            Wr = ["id", "name", "tagName", "type", "value"];
        ...
        const Kr = (e, t) => (n, {
                ...
                const o = e ? .target;
                (o instanceof HTMLInputElement || o instanceof HTMLSelectElement || o instanceof HTMLTextAreaElement) && !Ir(o) && (r ? n(`${r}${t}`, {
                    node: Vr(o)
                }) : n(t, {
                    element: Xr(o)
                }))
            })),
            Yr = Kr("blur", "input_blurred"),
            Jr = Kr("focus", "input_focused"),
            Gr = Kr("change", "input_changed");
        n(2341);
        const Zr = ["action", "id"],
            Qr = [Yr, Gr, (e, {
                eventPrefix: t
            } = {}) => Sr(self.window, "click", (n => {
                const r = n ? .target;
                if (!(r instanceof Element) || Ir(r)) return;
                const o = t ? Fr(n, r) : function(e, t) {
                    return {
                        element: Nr(t),
                        ...jr,
                        ...kr(e, Dr)
                ...
                const r = n ? .target;
                r instanceof HTMLFormElement && !Ir(r) && (t ? e(`${t}form_submitted`, {
                    node: Vr(r)
                }) : e("form_submitted", {
                    element: { ...Tr(r, Zr),
                        elements: Array.from(r.elements).filter((e => Hr.some((t => e instanceof t)) && !Ir(e))).map((e => Xr(e)))
                    }
                }))
            }))],
            eo = (e, t) => {
                const n = Qr.map((n => n(e, t)));
                return () => {
                    n.forEach((e => e()))
                }
            };
        ...
        const no = (e, t) => Array.from(e).reduce(((e, n) => (Ir(n) || e.push(t(n)), e)), []),
            ro = e => ({
                node: Vr(e),
                children: no(e.childNodes, ro),
                ...zr(e)
            }),
            oo = [e => {
                let t = null;
                return Sr(self.window, "mousemove", (n => {
                ...
                Ir(r) || e("advanced_dom_scrolled", {
                    node: Vr(r)
                })
            }), {
                throttleDelay: 100
            }), e => {
                const t = [to("cut", e), to("paste", e), to("copy", e)];
                return () => {
                    t.forEach((e => e()))
                }
            }, e => Sr(self.document, "selectionchange", (t => {
                const n = document.activeElement;
                n instanceof Element && !Ir(n) && e("advanced_dom_selection_changed", {
                    node: Vr(n)
                })
            }), {
                throttleDelay: 250
                ...
                const t = () => {
                    e("advanced_dom_available", {
                        root: ro(self.document)
                    })
                };
                return "loading" !== document.readyState ? (t(), () => {}) : Sr(self.window, "DOMContentLoaded", t)
            }, e => {
                const t = new MutationObserver((async t => {
                    await yr(), t.forEach((t => {
                        if (Ir(t.target)) return;
                        const n = no(Array.from(t.addedNodes).filter((e => e.parentNode)), ro),
                            r = function(e) {
                                if (0 === e.removedNodes.length) return [];
                                if (Ir(e.target)) return e.removedNodes.forEach((e => Br(e))), [];
                        ...
                        if ("attributes" === t.type) {
                            ...
                            n && e instanceof HTMLElement && t.oldValue !== e.getAttribute(n) && o.push(Vr(t.target))
                        }
                        if ("characterData" === t.type) {
                            const {
                                target: e
                            } = t;
                            e instanceof Text && t.oldValue !== e.data && o.push(Vr(e))
                        }
        ...
        let ao;
        const so = Object.values(Me),
            co = e => {
                const t = e.trim().toLowerCase();
                return n = t, so.includes(n) ? t : Me.NotAvailable;
                var n
            },
            uo = Object.values(je),
            lo = e => {
            ...
            fo = () => {
                const e = (() => {
                    ...
                    t = (e => {
                        const t = e.trim().toLowerCase();
                        return n = t, uo.includes(n) ? t : window.Shopify ? .Checkout ? je.Shopify : window.Shopify ? .analytics ? .replayQueue ? je.StorefrontRenderer : window.CardFields ? je.CheckoutOne : je.Unknown;
                        var n
                    })(e ? .surface ? ? "");
                return {
                    browserTarget: co(e ? .browserTarget ? ? ""),
                    surface: t,
                    ...
                    features: {
                        domEvents: "false" !== e ? .domEvents && t !== je.CheckoutOne && t !== je.CheckoutOneSdk,
                        advancedDomEvents: "false" !== e ? .advancedDomEvents,
                        storefrontEvents: "false" !== e ? .storefrontEvents && t === je.StorefrontRenderer,
                        cartPermalink: "false" !== e ? .cartPermalink && (t === je.CheckoutOne || t === je.StorefrontRenderer)
                    }
                }
            };
        try {
            ! function({
                ...
                try {
                    (({
                        ...
                        if (!e) throw new Qe("storefrontBaseUrl is required.");
                        if (! function(e) {
                                try {
                                    return new URL(e), !0
                                } catch (t) {
                            ...
                            }(e)) throw new Qe(`storefrontBaseUrl is not a valid absolute URL: "${e}"`)
                    })(e), Et(e.storefrontBaseUrl),
                        function(e = []) {
                            (Array.isArray(e) ? e : [e]).forEach((e => lt.add(e)))
                        }(e.enabledBetaFlags);
                    const {
                        shopId: r,
                        surface: o,
                    ...
                    if (self[ze]) {
                        ...
                        const r = new Error(`WebPixelsManager: ${ze} global object is already defined`);
                        return tt.notify(r, {
                    ...
                    const p = xt("load", {
                        ...
                        h = {
                            init(a) {
                                if (null !== self.location.href.match(/\/wpm@(.+)\/sandbox/)) return io;
                                const {
                                    initData: s,
                                    isMerchantRequest: p,
                                    monorailRegion: h,
                                ...
                                if (ao) return tt.notify(new Error(`WebPixelsManager: ${ze} is being initialized multiple times`), {
                                ...
                                const w = function() {
                                    ...
                                    return n.reverse().reduce(((e, t) => {
                                        const n = "" === e ? t : `${t}.${e}`;
                                        return function(e) {
                                                Xt(`${Yt}=1; path=/; domain=${e}`)
                                            }(n), Kt(Yt) || r.push(n),
                                            function(e) {
                                                Xt(`${Yt}=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT; domain=${e}`)
                                            }(n), n
                                    }), ""), Jt.set(e, r), r
                                }();
                                p && function() {
                                        try {
                                            self.sessionStorage.setItem(We, "true")
                                        } catch {}
                                    }(), Ne(), St = h, dt("a1498136") && m && !w.includes(m) && w.length > 0 && tt.notify(new Error("Discrepancy in server-side and client-side eTLD computation for writing cookies"), {
                                        context: "v0/createWebPixelsManager/init",
                                        severity: "warning",
                                        unhandled: !1,
                                    ...
                                    function() {
                                        try {
                                            return "true" === self.sessionStorage.getItem(We)
                                        } catch {
                                            return !1
                                        }
                                    }() && Tn.init(b);
                                ...
                                x = y, window.addEventListener("pagehide", (() => {
                                    x.payload.pageDuration = ht("page:session") ? .measurement ? .duration, It(x), Ot({
                                        skipXhr: !0
                                    })
                                }));
                                const _ = ar(b),
                                        ...
                                        return {
                                            ...
                                            subscribe(n, r, o = {}) {
                                                ...
                                                return t.subscribe(n, (t => {
                                                    if (e === je.CheckoutOneSdk && o.scope !== Nn.CheckoutOneSdk) return;
                                                    const n = {
                                                    ...
                                                    r.call(t, t), At("subscriberEventEmitPrivacy", {
                                                        version: Be,
                                                        bundleTarget: qe,
                                                        pageUrl: self.location.href,
                                                        shopId: o.shopId,
                                ...
                                try {
                                    if (self.Shopify && !0 === self.Shopify.designMode) return self.console && console.log("[WebPixelsManager] Prevented from executing in the Theme Editor"), io;
                                    if (/^web-pixel-sandbox/.test(self.name)) {
                                        const e = new Qe("WebPixelsManager: browser library is being run in a sandbox");
                                        throw S.library = "browser", tt.notify(e, S), e
                                    }
                                    o === je.CheckoutOneSdk && (v.length = 0);
                                    ...
                                    Promise.all(e.ready).then((() => function(e) {
                                        ...
                                        function() {
                                            if (!at) try {
                                                document.addEventListener(N, it), at = !0
                                            } catch (n) {
                                                tt.notify(n, {
                                        ...
                                        })), o !== je.CheckoutOne && o !== je.CheckoutOneSdk ? (function(e, t) {
                                            P(e, t),
                                                function(e, t) {
                                                    d((r => {
                                        ...
                                        }(_.publish, s), eo(_.publishDomEvent)) : o !== je.CheckoutOneSdk && function(e, t) {
                                            C(e, t)
                                        }(_.publish, s), v.some((({
                                            capabilities: e
                                        }) => (e || []).includes(Le.AdvancedDomEvents))) && (I = _.publishDomEvent, oo.map((e => e(I))), eo(_.publishDomEvent, {
                                            eventPrefix: "advanced_dom_"
                                        })), k.payload.status = "initialized", It(k);
                                    const t = function({
                                        addMonorailEvent: e,
                                        logError: t,
                                        userConsent: n,
                                    ...
                                    return ao = function({
                                        ...
                                        return {
                                            ...
                                            subscribe: (t, o, i) => e.subscribe(t, o, { ...i,
                                                shopId: n,
                                                surface: r,
                                                scope: r === je.CheckoutOneSdk ? Nn.CheckoutOneSdk : void 0
                                            }),
                                    ...
                                    return n instanceof Qe || tt.notify(n, {
                                        context: "v0/init",
                                        initConfig: b
                                    }), self.console && console.error(n), k.payload.status = "failed", k.payload.errorMsg = n ? .message, It(k), y.payload.runtimeErrorCaught = "true", io
                                }
                                var I
                            }
                        };
                    return Mt(self, ze, {
                        ...
                        configurable: !1,
                        enumerable: !1
                    }, !1), p.payload.status = "loaded", It(p), h
                } catch (n) {
                    const r = n instanceof Qe || "WebPixelsHandledError" === n.name;
                    return tt.notify(n, {
                        context: "v0/createWebPixelsManager",
                        severity: r ? "warning" : "error",
                        unhandled: !r
                    }), self.console && console.error(n), It(xt("load", {
                        version: Be,
                        bundleTarget: qe,
                        pageUrl: t,
